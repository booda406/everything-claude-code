...
这是一个**生产就绪的 AI 编码插件**，提供 39 个专业代理、163 项技能、78 条命令以及自动化钩子工作流，用于软件开发。
...
| ui-ux-designer | UX 规划、信息架构、设计系统方向、启发式与无障碍审查 | 新建或改版界面、UX 不明确、上线前界面打磨、面向工程的可交付规格 |
...
* 复杂功能请求 → **planner**
* 显著的 UI/UX 不确定性（流程、信息架构、设计系统、无障碍）→ **ui-ux-designer**
