...
**That's it!** You now have access to 39 agents, 163 skills, and 78 legacy command shims.
...
| Commands | PASS: 78 commands | PASS: 31 commands | **Claude Code leads** |
...
| **Commands** | 78 | Shared | Instruction-based | 31 |
